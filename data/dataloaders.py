...
class BA2grid(InMemoryDataset):
    def __init__(self, root = './data/datasets/BA2grid', transform=None, pre_transform=None, pre_filter=None):
        self.name = 'BA2grid'
        super().__init__(root, transform, pre_transform, pre_filter)
        self.explanations = self.loadExplanation()
        self.data, self.slices = torch.load(self.processed_paths[0])
...
class GridHouse(InMemoryDataset):
    def __init__(self, root = './data/datasets/GridHouse', transform=None, pre_transform=None, pre_filter=None):
        self.name = 'GridHouse'
        super().__init__(root, transform, pre_transform, pre_filter)
        self.explanations = self.loadExplanation()
        self.data, self.slices = torch.load(self.processed_paths[0])
...
class HouseColors(InMemoryDataset):
    def __init__(self, root = './data/datasets/HouseColors', transform=None, pre_transform=None, pre_filter=None):
...
class BA2Motif(InMemoryDataset):
    def __init__(self, root = './data/datasets/BA2Motif', transform=None, pre_transform=None, pre_filter=None):
        self.name = 'BA2Motif'
        super().__init__(root, transform, pre_transform, pre_filter)
        self.explanations = self.loadExplanation()
        self.data, self.slices = torch.load(self.processed_paths[0])
