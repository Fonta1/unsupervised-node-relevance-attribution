...
def split_data(dataset, mode = 'cross_validation_val', k=5):
    dataPath = dataset.root
    splitPath = f'{dataPath}\\splits'
    ...
    if mode == 'cross_validation_val':
        if os.path.isfile(f'{splitPath}\\cross_validation_val_{k}_splits.pkl'):
            with open(f'{splitPath}\\cross_validation_val_{k}_splits.pkl', 'rb') as f:
            ...
            with open(f'{splitPath}\\cross_validation_val_{k}_splits.pkl', 'wb') as f:
